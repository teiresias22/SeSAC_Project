        ...
        viewModel.checkCode { authresult, error in
            ...
            self.viewModel.getUserInfo { UserInfo, statuscode, error in
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 1) {
                    ...
                    windowScene.windows.first?.rootViewController = UINavigationController(rootViewController: MainHomeViewController())
                ...
                //그 외
                default: self.toastMessage(message: "알수없는 오류 발생 :\(statuscode)Error")
                }
            }
        }
    }
